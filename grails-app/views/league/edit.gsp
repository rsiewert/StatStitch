...
<%@ page import="com.alchemysoft.sports.League" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="conferences"><g:message code="league.conferences.label" default="Conferences" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: leagueInstance, field: 'conferences', 'errors')}">
